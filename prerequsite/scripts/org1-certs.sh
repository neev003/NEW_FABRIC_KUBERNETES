...
# Define variables
CA_SERVER="ca-org1:7054"
ORG_NAME="org1.example.com"
CA_NAME="ca-org1"
TLS_CERT_FILE="/ca-org1/tls-cert.pem"
PEER_NUMBER=${1:-0}
PEER_NAME="peer${PEER_NUMBER}"
PEER_SERVICE_NAME="${PEER_NAME}-org1-example-com"
...
log_info "Certificate generation for Org1 completed successfully"
